...
class Email_compra_models extends CI_Model {
    ...
    public function email_pago($listado_compra,$datos_personales,$monedaI,$config,$numero_orden) {
        ...
        $this->email->bcc('adrian.nicholay93@gmail.com,joy.saavedraa@gmail.com,rjsimosa@gmail.com,info@aventuras.pe');
        ...
        if($listado_compra) {  
            $precio_total=0;
            $message= '
                    <table width="100%" style="font-family:sans-serif;color:#555;background:#de1c2f;padding:10px 50px;color:#fff;">
                        <tr>
                                ...
                                <table width="100%" style="font-family: sans-serif;color:#555;">
                                    <tr>
                                        ...
                                        <td>
                                            <table width="60%">
                                                <tr height="45px">
                                                    <td colspan="4" align="left" style="color:#f38b5a;font-size:25px;"><b>'.$row['textservicio'].'</b></td>
                                                </tr>
                                                
                                                <tr height="45px" style="font-size:14px;">
                                                    <td style="border-right-style: dotted;border-color: #f38b5a;" align="center"><i class="icon-calendar-inv tamano-icono-res"></i><br>'.$row['textfecha'].'<br>Llegada&nbsp;</td>
                                                    <td style="border-right-style: dotted;border-color: #f38b5a;" align="center"><i class="icon-adult tamano-icono-res"></i><br>'.$row['textqtyAdulto'].'<br>Adultos&nbsp;</td>
                                                    <td style="border-right-style: dotted;border-color: #f38b5a;" align="center"><i class="icon-child tamano-icono-res"></i><br>'.$row['textqtyNino'].'<br>Niños&nbsp;</td>
                                    ...
                                    <tr height="45px">
                                        <td align="right" colspan="2" style="font-size:20px;background:#9e9e9e2b;"><b><text style="font-size:15px;">'.$row['textmoneda'].'</text>&nbsp;'.number_format($precio).'</b></td>
                                    </tr>
                                </table>
                            '; 
                $precio_total+=$precio;  
        ...
        $message.= '
                        <table width="100%" style="font-family:sans-serif;color:#555;font-size:30px;">
                            <tr>
                                <td align="right" colspan="2" style="padding:10px;background:#de1c2f;color:#fff;"><b><text style="font-size:15px;">'.$row['textmoneda'].'</text>&nbsp;'.number_format($precio_total).'</b></b></td>
                            </tr>
                        </table>
                        <br>
    ...
    public function email_reclamacion($dni,$nombre,$email,$numero,$problema,$solucion,$direccion,$actividad,$servicio,$numero_reclamo,$config) {
        ...
        $message.= '
                        ...
                        <table width="100%" style="font-family:sans-serif;color:#555;font-size:16px;">
                            <tr>
                                <td align="left" style="background:#de1c2f;color:#fff;padding:10px 30px;">
                                    <b><text style="font-size:20px;">Datos del proveedor</text></b>
                                    <br><br>Aventuras Tours
                                    <br>info@aventuras.pe
                                    <br>+ (51) 910926882
