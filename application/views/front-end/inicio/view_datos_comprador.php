        ...
        <div class="container">
			...
			<div class="bs-wizard clearfix">
                ...
                <div class="bs-wizard-step disabled">
                    <div class="text-center bs-wizard-stepnum">Realizar de pago</div>
                    <div class="progress">
                        <div class="progress-bar"></div>
                    </div>
    ...
    <div class="container margin_60_35">
                ...
                <div class="step">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="textdocumentores" name="textdocumentores" placeholder="Número de documento">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label>NOMBRES</label>
                                <input type="text" class="form-control" id="textnombresres" name="textnombresres" placeholder="Nombres" >
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="textapellidosres" name="textapellidosres" placeholder="Apellidos">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input name="textoutputres" type="hidden" id="textoutputres">
                                <input type="tel" id="textnumerores" name="textnumerores" class="form-control validaSoloNumeros">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="email" id="textemailres" name="textemailres" class="form-control" placeholder="Correo electrónico">
        ...
        <aside class="col-lg-4" id="sidebar">
            <div class="box_detail">
                <div id="total_cart">RESUMEN DE RESERVA</div>
                <?php
                    $precio_total=0;
                    ...
                    if($listado_compra) {
                        ...
                        echo '
                            <ul class="cart_details">
                                <li class="titulo-detalle">No hay lista de reserva.</li>
                            </ul>
                        ';
                    }
                ?>
                ...
                <input type="button" class="btn_1 full-width purchase btn-continuar" value="Continuar" <?= $divOculto;?>>
                <a href="<?= site_url("reserva/carrito/$moneda");?>" class="btn_1 full-width outline wishlist" <?= $divOculto;?>><i class="icon-edit"></i>&nbsp;Editar carrito</a>
