                    ...
                    <div class="box_list isotope-item">
                        <div class="row no-gutters">
                            ...
                            <figure>
                                ...
                                <a href="'.$row->url.'"><img loading="lazy" src="'.$row->urlimg.'" class="img-fluid img-fluid-22" alt="" intrinsicsize="800 x 533"><div class="read_more"><span>Visualizar</span></div></a>
