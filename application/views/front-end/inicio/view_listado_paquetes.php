        ...
        <div class="div-imagen-banner">
            ...
            <center>
                <div class="text-imagen-banner-1">
                    <span class="contador-banner"><?= count($paquetes);?><br></span>
    ...
    <div class="row">
                ...
                <div class="collapse show" id="collapseFilters">
                    ...
                    <div class="filter_type">
                        ...
                        <ul>
                            <li>
                                <label>
                                	<input type="radio" class="icheck listing_tipo" name="listing_tipo" value="tours">Tours <small>(<?= $cantidad_tours[0]->cantidad;?>)</small>
								</label>
                            </li>  
                            <li>
                                <label>
                                	<input type="radio" class="icheck listing_tipo" name="listing_tipo" value="paquetes" checked>Paquetes <small id="cant_filtro">(<?= count($paquetes);?>)</small>
								</label>
                            </li>
                        </ul>
                    </div>
                                        ...
                                        <?php 
                                            ...
                                            if($destinos) {
                                                foreach($destinos as $row) {
                                                    ...
                                                    echo    '   
                                                                <option value="'.site_url("paquetes/".strtolower($row->distrito)."/$moneda").'" '.$selected.'>'.ucfirst(strtolower($row->distrito)).'</option>
                                                            ';  
                                                }
                                            }                 
                                        ?>
        ...
        <div class="col-lg-9" id="list_sidebar">
            <div class="isotope-wrapper">
                <?php $this->load->view('front-end/inicio/view_grid_paquetes');?>
            </div>
        </div>
        <!-- /tours-->  
    </div>
