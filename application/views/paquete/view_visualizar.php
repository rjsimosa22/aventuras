                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="panel-body collapse in">
                                            <div class="table-responsive" style="border:0;">
                                                <table cellpadding="0" cellspacing="0" border="0"class="table table-striped table-bordered datatables" id="example1" width="100%">
                                                    <thead>
                                                        <tr>
                                                            <th width="15%">Día&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
                                                            <th width="23%">Tours Básico</th>
                                                            <th width="23%">Tours Exclusivo</th>
                                                            <th width="23%">Tours Recomendado</th>
                            ...
                            <fieldset title="Paso 3">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="panel-body collapse in">
                                            <div class="table-responsive" style="border:0;">
                                                <table cellpadding="0" cellspacing="0" border="0"class="table table-striped table-bordered datatables" id="example2" width="100%">
                                                    <thead>
                                                        <tr>
