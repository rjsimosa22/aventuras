                            ...
                            <div class="panel-body collapse in">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4">
                                        ...
                                        <input type="text" name="ced" id="ced" class="form-control" placeholder="Ingresé cédula del usuario" onKeyPress="return soloNumeros(event)" autocomplete="off" />
                                    </div>

                                    <div class="col-sm-4">
                                        <label class="col-sm-0 control-label">Nombre:</label>
                                        <input type="text" name="nom" id="nom" class="form-control" placeholder="Ingresé nombre del usuario" onKeyPress="return soloLetras(event)" autocomplete="off" />
                                    </div>

                                    <div class="col-sm-4">
                                        <label class="col-sm-0 control-label">Apellido:</label>
                                        <input type="text" name="ape" id="ape" class="form-control" placeholder="Ingresé apellido del usuario" onKeyPress="return soloLetras(event)" autocomplete="off" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <input type="password" name="clav" id="clav" class="form-control" placeholder="Ingresé clave" autocomplete="off" />
                                    </div>

                                    <div class="col-sm-4">
                                        <label class="col-sm-0 control-label">Repetir Clave:</label>
                                        <input type="password" name="clav1" id="clav1" class="form-control" placeholder="Ingresé clave" autocomplete="off" />
                                    </div>
                                </div>
