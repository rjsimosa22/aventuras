...
function onPaymentAuthorized(paymentData) {
  return new Promise(function(resolve, reject){
    ...
    .then(function() {
      ...
      window.location=$('#texturl').val()+'tramite/pago/exitoso/';
      })
      .catch(function() {
        resolve({
          ...
          error: {
            ...
            message: "Fondos insuficientes, intente nuevamente. El próximo intento debería funcionar.",
...
function getGoogleTransactionInfo() {
  ...
  if(listado_compra) {
    ...
    return {
      ...
      countryCode: 'US',
      currencyCode: $('#tipo_mercado_pago').text(),
